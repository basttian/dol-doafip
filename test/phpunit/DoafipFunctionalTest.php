...
/**
 * \file    test/phpunit/DoafipFunctionalTest.php
 * \ingroup doafip
 ...
 * @package Testdoafip
 */
class DoafipFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/doafip/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('doafip/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/doafip/admin/about.php');
		$this->authenticate();
		return $this->assertContains('doafip/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('doafipwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoafip_DoafipTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoafip_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
